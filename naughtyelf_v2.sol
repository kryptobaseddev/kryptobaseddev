...
TAKING REWARDS AND REFELCTIONS TO A WHOLE NEW LEVEL!!!!
...
contract GRINCHBONK is Context, IERC20, Ownable {
    ...
    string private constant _name = "NaughtyElf";
    string private constant _symbol = "$NELF";
...
//SellFees = 15% with 10% naughty tax to 12-25
